...
public class TestDataInit {
    ...
    public void init(){
        ...
        TeaCategory drinkTeaCategory = drink.getTeaCategories().get(0);
        ...
        Coffee coffee1 = createCoffee("Americano(Hot)", 2000, 10000,
                ...
                "에스프레소에 뜨거운 물을 희석시켜 만든 음료", false, drinkTeaCategory, coffeeTeaCategory);
        ...
        Coffee coffee2 = createCoffee("Americano(Ice)", 2000, 10,
                ...
                "에스프레소에 찬 물을 희석시켜 만든 음료", false, drinkTeaCategory, coffeeTeaCategory);
        ...
        Coffee coffee3 = createCoffee("Caffe Latte(Hot)", 2500, 20,
                ...
                "리스트레또 더블샷과 스팀우유를 넣어 만든 베이직 커피 음료", false, drinkTeaCategory, coffeeTeaCategory);
        ...
        Ade ade1 = createAde("자몽 에이드(Ice)", 3000, 50,
                ...
                "자몽의 과즙에 탄산 따위를 넣어 만든 음료", false, drinkTeaCategory, adeTeaCategory);
        ...
        TeaPack teaPack1 = createTeaPack("자몽 티(Hot)", 3000, 80,
                ...
                "자몽의 과즙에 따끈한 물 따위를 넣어 만든 음료", false, drinkTeaCategory, teaPackTeaCategory);
        teaRepository.save(teaPack1);

        teaCategoryRepository.save(drinkTeaCategory);
