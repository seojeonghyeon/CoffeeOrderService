...
import me.justin.coffeeorderservice.infra.exception.*;
import me.justin.coffeeorderservice.modules.vo.RequestMemberSave;
...
@Slf4j
@Controller
@RequestMapping(MemberApiController.ROOT)
